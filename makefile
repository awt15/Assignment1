...
$(BUILD_DIR)/WeaponFactory.o: $(BUILD_DIR) $(BUILD_DIR)/CommonSword.o $(BUILD_DIR)/CommonSpear.o $(BUILD_DIR)/CommonBow.o $(BUILD_DIR)/SimpleAxe.o $(BUILD_DIR)/CrazyRandomSword.o WeaponFactory.cpp WeaponFactory.h
...
$(BUILD_DIR)/CommonBow.o: $(BUILD_DIR) $(BUILD_DIR)/Weapon.o CommonBow.cpp CommonBow.h
	$(CXX) $(CXXFLAGS) -c -o $@ CommonBow.cpp
